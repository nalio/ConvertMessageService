...
public class ConvertMessageService implements XQService {
	...
	private static int s_buildNumber = 14;
	...
	private void convertMessageServiceContext(XQServiceContext ctx)
		...
		final int messagePart = params.getIntParameter(PARAM_NAME_MESSAGE_PART, XQConstants.PARAM_STRING);
